...
function panm360_taxonomies() {
	...
	register_taxonomy( 'generale', array(  'post','artiste','records' , 'agenda','ecoutes','podcasts' ), $args_generale );
	...
	register_taxonomy( 'genre', array(  'post','artiste','records' , 'agenda','ecoutes', 'interviews','podcasts' ), $args_genre );
	...
	register_taxonomy( 'annee', array(  'post','artiste','records','ecoutes','podcasts' ), $args_annee_album );
	...
	register_taxonomy( 'pays', array( 'post','artiste','records' , 'agenda','ecoutes','podcasts' ), $args_pays );
	...
	register_taxonomy( 'label', array( 'post','artiste','records','ecoutes','podcasts' ), $args_label );
