...
function panm360_scripts() {
	...
	wp_enqueue_style( 'panm360-slick', get_template_directory_uri().'/assets/vendor/slick/slick-theme.css' );
	wp_enqueue_style( 'panm360-style', get_template_directory_uri().'/assets/css/main.css' );
	
	
	wp_enqueue_script( 'script-slick', get_template_directory_uri() . '/assets/vendor/slick/slick.min.js', array(), false, false );
